import type { AgentConfig, TokenResponse, ChatResponse } from "../types";
...
export function connectTranscriptWs(
  ...
  if (API_BASE.startsWith("http://") || API_BASE.startsWith("https://")) {
    ...
    wsUrl = `${url.protocol === "https:" ? "wss:" : "ws:"}//${url.host}/api/voice-agent/transcripts/live/${roomName}`;
  } else {
    wsUrl = `${window.location.protocol === "https:" ? "wss:" : "ws:"}//${window.location.host}${API_BASE}/api/voice-agent/transcripts/live/${roomName}`;
  }
